...
class ProductListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView) viewProduct.findViewById(R.id.idproduct)).setText(String.format("%d", product.productID));
        ((TextView) viewProduct.findViewById(R.id.nameproduct)).setText(String.format("%s", product.name));
        ((ImageView) viewProduct.findViewById(R.id.image)).setImageResource(((Product) getItem(position)).image);
